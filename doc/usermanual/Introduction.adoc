...
* Supports a subset of Kotlin 1.9 language and standard libraries. Kotlin is a great, descriptive and flexible language. Check the <<_language, differences between Kotlite and Kotlin>>.
